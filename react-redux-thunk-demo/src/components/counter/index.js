...
import { counter_add_action,counter_add_async_action, counter_take_action } from "../../reducers/counter";
	...
	render(){
		...
		return (
			<div>
				...
				<button onClick={counter_add_async_action}>异步增加</button>
...
const mapDispatchToProps = dispatch => ({
	...
	counter_add_async_action: () => dispatch(counter_add_async_action)	
